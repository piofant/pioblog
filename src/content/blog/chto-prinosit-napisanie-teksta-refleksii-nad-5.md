...
subtitle: 'последовательное формулирование проблемы и дальнейшая её постепенная структуризация, в процессе которой можно придти к каким-то дополнительным не очевидным мыслям'
pubDate: '2020-08-12'

...
const TAG_RULES = [
	...
	{ tag: 'школа жизни', patterns: [ws('школ[аеыу]'), ws('класс'), ws('физтех'), ws('физмат'), ws('универ'), ws('ВУЗ'), ws('ИТМО'), ws("МФТИ"), ws("МИСиС"), ws("МИФИ"), ws("ЦУ"), ws('студен'), ws('абитуриент'), ws('олимпиад')] },
	...
	{ tag: 'психология',  patterns: [ws('психолог'), ws('мантр'), ws('принят'), ws('благодарност'), ws('эмпати'), ws('самооценк'), ws('одиночеств'), ws('страх'), ws('терапи'), ws("ДБТ")] },

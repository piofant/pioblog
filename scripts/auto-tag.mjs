...
const TAG_RULES = [
	...
	{ tag: 'школа жизни', patterns: [ws('школ[аеыу]'), ws('класс'), ws('физтех'), ws('физмат'), ws('универ'), wb('ВУЗ'), wb('ИТМО'), wb('МФТИ'), wb('МИСиС'), wb('МИФИ'), wb('ЦУ'), ws('студен'), ws('абитуриент'), ws('олимпиад')] },
	{ tag: 'вуз',         patterns: [wb('ВУЗ'), ws('бакалавр'), ws('университет'), ws('студент'), /поступлени.{0,15}в.{0,5}топ/iu, wb('ИТМО'), wb('МФТИ'), wb('МИСиС'), wb('МИФИ'), wb('ЦУ'), ws('диплом'), ws('диссертац'), ws('курсовая')] },
